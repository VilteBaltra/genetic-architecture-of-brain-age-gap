...
* *rg_among_six_BAGs_Figure-2A.py*: Plots genetic correlations among the six BAGs (Figure 2A)
...
* *rg_BAGHan_with_33traits_Figure-S2.sh*: Script to generate genetic correlation plots the BAGHan and 33 traits (Supplementary Figure S2)

* *plot-forward-MR-inputGWASs-Figure-S7.R*: Plots forward MR results for BAG factor and each of the six input GWASs (Supplementary Figure S7)

* *plot-reverse-MR-inputGWASs-Figure-S8.R*: Plots reverse MR results for BAG factor and each of the six input GWASs (Supplementary Figure S8)

* *MRlap-IVW-df-plotting-forward-and-reverse-Figure-S9.py*: Plots forward and reverse MR results using MRlap estimates (Supplementary Figure S9).
