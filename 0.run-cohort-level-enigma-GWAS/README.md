...
This folder provides scripts to derive Han's brain age gap (BAG) and to perform a genome-wide association study (GWAS) on it. There are two main components: phenotypic scripts and genetic (GWAS) scripts.
